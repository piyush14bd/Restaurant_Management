...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while fetching the invoice items"})
		}
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		result, insertErr := foodCollection.InsertOne(ctx, invoice)
		if insertErr != nil {
...
func UpdateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if invoice.Payment_status != nil {
			updateObj = append(updateObj, bson.E{"payment_method", invoice.Payment_status})
			return
		}
